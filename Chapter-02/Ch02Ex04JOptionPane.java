...
public class Ch02Ex04JOptionPane {
    public static void main(String [] args){
        ...
        if (yesno == 0) {
            String[] fselection = {"사과", "바나나", "포도"};
            String[] wselection = {"쇼핑백", "상자", "맨손"};
            String fruit = (String) JOptionPane.showInputDialog(null, "과일을 선택하십시오.", "과일 선택", JOptionPane.PLAIN_MESSAGE, null, fselection, fselection[0]);
